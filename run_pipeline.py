#!/usr/bin/env python3
"""
Wrapper script to run the full pipeline from the root alert-fatigue directory.
"""
...
def main():
    """Run the full pipeline script from the model_pipeline directory."""
    ...
    if not os.path.exists(script_path):
        print(f"ERROR: run_pipeline.py not found in {model_pipeline_dir}")
        return
    
    print(f"Running full pipeline from: {os.getcwd()}")
    print("=" * 50)
